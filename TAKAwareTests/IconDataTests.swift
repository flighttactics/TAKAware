...
final class IconDataTests: TAKAwareTestCase {
    ...
    func testRetrieveIconForIconset() async throws {
        ...
        let actualIcon = await IconData.iconFor(type2525: "a-F-G", iconsetPath: iconString)
        XCTAssertEqual(actualIcon.icon.pngData(), expectedIcon.icon.pngData())
    }
    
    func testIconForReturnsUnknownMarkerWhenNo2525ImgFound() async {
        ...
        let actualIcon = await IconData.iconFor(type2525: "a-X-Y-Z", iconsetPath: "")
        XCTAssertEqual(actualIcon.icon.pngData(), expectedIcon.icon.pngData())
    }
    
    func testIconForReturns2525ImgWhenIconsetPopulatedButNotPresent() async {
        ...
        let actualIcon = await IconData.iconFor(type2525: "a-H-G", iconsetPath: "1234abz1234/Fake/Nothing-To-See.png")
        XCTAssertEqual(actualIcon.icon.pngData(), expectedIcon.icon.pngData())
    }
    
    func testIconForReturnsUnknownMarkerWhenIconsetPopulatedButNotPresentAndNo2525ImgFound() async {
        let unknownCloverImgData = ""
        let expectedIcon = buildTestIconFromBase64String(unknownCloverImgData)
        
        let actualIcon = await IconData.iconFor(type2525: "a-X-Y-Z", iconsetPath: "1234abz1234/Fake/Nothing-To-See.png")
        XCTAssertEqual(actualIcon.icon.pngData(), expectedIcon.icon.pngData())
    }
    ...
    func testParseCustomIconWithSpaceInName() async {
        let hostileGroundImgData = ""
        let expectedIcon = buildTestIconFromBase64String(hostileGroundImgData)
